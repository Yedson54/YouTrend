...
dash.register_page(__name__, name='Duration Model', order=3)

from backend.make_predictions import get_video_details, VIDEO_CAT_ENCODER,survival_probability,plot_survival_probability
from backend.utils import get_video_id
